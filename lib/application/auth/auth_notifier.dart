...
class AuthState {
  ...
  factory AuthState.authenticated({required int userId, String? email}) =>
  ...
  factory AuthState.loading(AuthState currentState) =>
    ...
    try {
      ...
      if (token != null && token.isNotEmpty && userIdStr != null) {
        ...
        if (userId != null) {
          ...
          state = AuthState.authenticated(userId: userId, email: user?.email);
          return;
        }
      }
  ...
  Future<bool> login({required String email, required String password}) async {
    ...
    try {
      ...
      if (user != null) {
        ...
        state = AuthState.authenticated(userId: user.id, email: user.email);
        return true;
      } else {
