...
const PomodoroSessionModelSchema = CollectionSchema(
  ...
  properties: {
    r'activeSegmentStartedAt': PropertySchema(
      id: 0,
      name: r'activeSegmentStartedAt',
    ...
    r'planId': PropertySchema(id: 11, name: r'planId', type: IsarType.long),
    ...
    r'taskId': PropertySchema(id: 16, name: r'taskId', type: IsarType.long),
...
void _pomodoroSessionModelSerialize(
  ...
  writer.writeDateTime(offsets[0], object.activeSegmentStartedAt);
  writer.writeLong(offsets[1], object.actualBreakSeconds);
  writer.writeLong(offsets[2], object.actualFocusSeconds);
  writer.writeDateTime(offsets[3], object.breakEndAt);
  writer.writeLong(offsets[4], object.breakMinutes);
  writer.writeDateTime(offsets[5], object.breakStartedAt);
  writer.writeDateTime(offsets[6], object.completedAt);
  writer.writeDateTime(offsets[7], object.createdAt);
  writer.writeDateTime(offsets[8], object.focusCompletedAt);
  writer.writeLong(offsets[9], object.focusMinutes);
  writer.writeLong(offsets[10], object.pausedRemainingSeconds);
  writer.writeLong(offsets[11], object.planId);
  writer.writeLong(offsets[12], object.sessionIndex);
  writer.writeDateTime(offsets[13], object.startedAt);
  writer.writeByte(offsets[14], object.status.index);
  writer.writeDateTime(offsets[15], object.targetEndAt);
  writer.writeLong(offsets[16], object.taskId);
...
PomodoroSessionModel _pomodoroSessionModelDeserialize(
  ...
  object.activeSegmentStartedAt = reader.readDateTimeOrNull(offsets[0]);
  object.actualBreakSeconds = reader.readLong(offsets[1]);
  object.actualFocusSeconds = reader.readLong(offsets[2]);
  object.breakEndAt = reader.readDateTimeOrNull(offsets[3]);
  object.breakMinutes = reader.readLong(offsets[4]);
  object.breakStartedAt = reader.readDateTimeOrNull(offsets[5]);
  object.completedAt = reader.readDateTimeOrNull(offsets[6]);
  object.createdAt = reader.readDateTime(offsets[7]);
  object.focusCompletedAt = reader.readDateTimeOrNull(offsets[8]);
  object.focusMinutes = reader.readLong(offsets[9]);
  object.id = id;
  object.pausedRemainingSeconds = reader.readLongOrNull(offsets[10]);
  object.planId = reader.readLong(offsets[11]);
  object.sessionIndex = reader.readLong(offsets[12]);
  ...
  object.targetEndAt = reader.readDateTimeOrNull(offsets[15]);
  object.taskId = reader.readLong(offsets[16]);
...
extension PomodoroSessionModelQueryFilter
  ...
  >
  activeSegmentStartedAtIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNull(property: r'activeSegmentStartedAt'),
      );
    });
  }
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  activeSegmentStartedAtIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNotNull(property: r'activeSegmentStartedAt'),
      );
    });
  }
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  activeSegmentStartedAtEqualTo(DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(
          property: r'activeSegmentStartedAt',
          value: value,
        ),
      );
    });
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  activeSegmentStartedAtGreaterThan(DateTime? value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  activeSegmentStartedAtLessThan(DateTime? value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
...
extension PomodoroSessionModelQuerySortBy
  ...
  sortByActiveSegmentStartedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'activeSegmentStartedAt', Sort.asc);
    });
  }

  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel, QAfterSortBy>
  sortByActiveSegmentStartedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'activeSegmentStartedAt', Sort.desc);
    });
  }
...
extension PomodoroSessionModelQuerySortThenBy
  ...
  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel, QAfterSortBy>
  thenByActiveSegmentStartedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'activeSegmentStartedAt', Sort.desc);
    });
  }
...
extension PomodoroSessionModelQueryWhereDistinct
  ...
  distinctByActiveSegmentStartedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'activeSegmentStartedAt');
    });
  }
...
extension PomodoroSessionModelQueryProperty
  ...
  activeSegmentStartedAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'activeSegmentStartedAt');
    });
  }
