...
class _FocusStyle {
  static const background = Color(0xFFF6EFE4);
  static const paper = Color(0xFFFFFAF0);
  static const ink = Color(0xFF3D352C);
  static const mutedInk = Color(0xFF766A5D);
  static const line = Color(0xFFE5D8C6);
  static const accent = Color(0xFF98B7A5);
  static const warm = Color(0xFFD8A85F);
  static const danger = Color(0xFFB7604B);
}
...
class _FocusPageState extends ConsumerState<FocusPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: _FocusStyle.background,
      appBar: AppBar(
        backgroundColor: _FocusStyle.background,
        foregroundColor: _FocusStyle.ink,
        title: const Text('专注'),
        titleTextStyle: Theme.of(context).textTheme.titleLarge?.copyWith(
          color: _FocusStyle.ink,
        ...
        actions: [
          if (userId != null)
            IconButton(
              ...
              onPressed: () => _showSavedLists(context, ref, userId, today),
            ),
          if (userId != null)
            IconButton(
              tooltip: '刷新今日番茄计划',
              ...
              onPressed: () => ref.invalidate(
                todayPomodoroPlanProvider((userId: userId, date: today)),
              ),
            ),
        ],
      ),
      body: _buildBody(authState, userId, today),
  ...
  Future<void> _showSavedLists(
    ...
    try {
      final plan = await ref.read(
        todayPomodoroPlanProvider((userId: userId, date: today)).future,
      );
      ...
      unawaited(
        showModalBottomSheet<void>(
          ...
          builder: (context) =>
              _SavedPomodoroListsSheet(userId: userId, plan: plan),
        ),
      );
    } catch (error) {
      if (!context.mounted) return;
  ...
  Widget _buildBody(AuthState authState, int? userId, DateTime today) {
    ...
    if (userId == null) {
      ...
      return const Center(child: Text('登录状态已失效，请重新登录。'));
    }
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: Theme.of(context).textTheme.bodySmall
                              ?.copyWith(color: _FocusStyle.mutedInk),
                        ),
                        const Spacer(),
                        TextButton.icon(
                          onPressed: () =>
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: Theme.of(
              context,
            ).textTheme.bodySmall?.copyWith(color: _FocusStyle.mutedInk),
          ),
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              backgroundColor: _FocusStyle.line,
              valueColor: const AlwaysStoppedAnimation(_FocusStyle.accent),
            ),
          ),
          const SizedBox(height: 12),
          Wrap(
          ...
          if (schedule.hasConflicts) ...[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: _FocusStyle.danger.withValues(alpha: 0.5),
                ),
              ),
              child: Text(
                ...
                style: Theme.of(
                  context,
                ).textTheme.bodySmall?.copyWith(color: _FocusStyle.danger),
              ),
            ),
          ],
          if (running != null && runningTask != null) ...[
            ...
            Text(
              ...
              style: Theme.of(
                context,
              ).textTheme.bodyMedium?.copyWith(color: _FocusStyle.mutedInk),
            ),
          ],
        ],
      ),
...
class _OperationGuide extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _GlassPanel(
      ...
      color: _FocusStyle.paper.withValues(alpha: 0.54),
      borderColor: _FocusStyle.line.withValues(alpha: 0.72),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(
      ...
      child: SafeArea(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                const Icon(Icons.history_rounded, color: _FocusStyle.ink),
                const SizedBox(width: 8),
                Text(
                  '专注历史',
              ...
              ConstrainedBox(
                ...
                child: ListView.separated(
                  ...
                  separatorBuilder: (_, _) =>
                      const Divider(color: _FocusStyle.line, height: 1),
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      leading: const Icon(
                        ...
                        color: _FocusStyle.accent,
                      ),
                      title: Text(
                        '${(session.actualFocusSeconds / 60).round()} 分钟专注',
                        style: const TextStyle(color: _FocusStyle.ink),
                      ),
                      subtitle: Text(
                        DateFormat('MM月dd日 HH:mm').format(time),
                        style: const TextStyle(color: _FocusStyle.mutedInk),
                      ),
                    );
                  },
                ),
...
class _SavedPomodoroListsSheet extends ConsumerWidget {
  const _SavedPomodoroListsSheet({required this.userId, required this.plan});
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final listsAsync = ref.watch(savedPomodoroListsProvider(userId));
    return _GlassPanel(
      margin: EdgeInsets.zero,
      padding: const EdgeInsets.fromLTRB(20, 18, 20, 28),
      radius: const BorderRadius.vertical(top: Radius.circular(28)),
          ...
          children: [
            ...
            listsAsync.when(
              ...
              error: (error, _) => Padding(
                ...
                child: Text(
                  '加载保存列表失败：$error',
                  style: const TextStyle(color: _FocusStyle.danger),
                ),
              ),
              data: (lists) {
                if (lists.isEmpty) {
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            style: TextButton.styleFrom(foregroundColor: _FocusStyle.danger),
            child: const Text('删除'),
          ),
        ],
      ),
          ...
          Row(
            ...
            children: [
              Container(
                ...
                height: 42,
                decoration: BoxDecoration(
                  color: _FocusStyle.accent.withValues(alpha: 0.22),
                  borderRadius: BorderRadius.circular(14),
                ),
                child: const Icon(Icons.timer_rounded, color: _FocusStyle.ink),
              ),
  ...
  Widget build(BuildContext context) {
    return OutlinedButton.icon(
      ...
      style: OutlinedButton.styleFrom(
        foregroundColor: _FocusStyle.ink,
        side: const BorderSide(color: _FocusStyle.line),
      ...
      child: ClipRRect(
        ...
        child: BackdropFilter(
          ...
          child: Container(
            padding: padding,
            decoration: BoxDecoration(
              color: color ?? _FocusStyle.paper.withValues(alpha: 0.78),
              borderRadius: radius,
              border: Border.all(
              ...
              boxShadow: [
                BoxShadow(
                  color: const Color(0xFF8A6F4E).withValues(alpha: 0.14),
                  blurRadius: 24,
        ...
        children: [
          ReorderableDragStartListener(
            ...
            child: Container(
              ...
              height: 42,
              decoration: BoxDecoration(
                color: _FocusStyle.line.withValues(alpha: 0.55),
                borderRadius: BorderRadius.circular(14),
              ),
              child: const Icon(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: Text(running ? '番茄进行中' : '开始当前番茄'),
                    style: ElevatedButton.styleFrom(
                      backgroundColor: _FocusStyle.accent,
                      foregroundColor: Colors.white,
                      disabledBackgroundColor: _FocusStyle.line,
                      disabledForegroundColor: _FocusStyle.mutedInk,
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    _TaskActionChip(
                      ...
                      danger: true,
                      onPressed: () =>
                          ref.read(pomodoroActionsProvider).removeTask(task),
                    ),
                  ],
                ),
              ],
...
class _TaskActionChip extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = danger ? _FocusStyle.danger : _FocusStyle.ink;
    return OutlinedButton.icon(
      onPressed: onPressed,
      ...
      style: OutlinedButton.styleFrom(
        ...
        disabledForegroundColor: _FocusStyle.mutedInk.withValues(alpha: 0.45),
